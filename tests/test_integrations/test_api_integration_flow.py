...
class TestAPIIntegrationFlow:
    ...
    @patch('src.voice_task_manager.core.processor.GoogleDriveIntegration')
    @patch('src.voice_task_manager.core.processor.VoiceTranscriber')
    @patch('src.voice_task_manager.core.processor.NotionIntegration')
    @patch('src.voice_task_manager.core.processor.VoiceDatabase')
    ...
    @patch('src.voice_task_manager.core.processor.NotionIntegration')
    @patch('src.voice_task_manager.core.processor.VoiceDatabase')
    @patch('src.voice_task_manager.core.processor.VoiceNotificationSystem')
